...
LDLIBSOPTIONS=-L../glfw-win32/dist/Release/CLang-Windows -lopengl32 -lgdi32 ../glfw-win32/dist/Debug/CLang-Windows/libglfw-win32.a ../glfw-win32/dist/Release/CLang-Windows/libglfw-win32.a
...
${OBJECTDIR}/_ext/1445274692/main.o: ../../src/main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../../thirdparty/tinycthread -I../../thirdparty/glfw/include -I../../src -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/main.o ../../src/main.c

${OBJECTDIR}/_ext/1445274692/modcurse.o: ../../src/modcurse.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../../thirdparty/tinycthread -I../../thirdparty/glfw/include -I../../src -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/modcurse.o ../../src/modcurse.c

${OBJECTDIR}/_ext/1445274692/modveskrl.o: ../../src/modveskrl.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../../thirdparty/tinycthread -I../../thirdparty/glfw/include -I../../src -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/modveskrl.o ../../src/modveskrl.c

${OBJECTDIR}/_ext/1445274692/vutil.o: ../../src/vutil.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../../thirdparty/tinycthread -I../../thirdparty/glfw/include -I../../src -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/vutil.o ../../src/vutil.c

${OBJECTDIR}/_ext/31909533/tinycthread.o: ../../thirdparty/tinycthread/tinycthread.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/31909533
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../../thirdparty/tinycthread -I../../thirdparty/glfw/include -I../../src -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/31909533/tinycthread.o ../../thirdparty/tinycthread/tinycthread.c
